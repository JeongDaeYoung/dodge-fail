...
public class Start extends JFrame implements ActionListener, MouseListener {
	...
	ImageIcon imgSelect = new ImageIcon("./images/BG.png");
	...
	JButton btnJinho = new JButton(new ImageIcon("./images/selectStu1.png")); // 진호 선택버튼
	JButton btnDaeyoung = new JButton(new ImageIcon("./images/selectStu2.png")); // 대영 선택버튼
	JButton btnSeungri = new JButton(new ImageIcon("./images/selectStu3.png")); // 승리 선택버튼
	...
	public void thstop() { // 스레드 정지 메소드 생성
		th.interrupt();
	}
}