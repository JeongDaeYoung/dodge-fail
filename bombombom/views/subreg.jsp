...
<body>
  ...
  <div class="padding1">
	...
	<tbody>
		...
		<form action="subreg" method="post">
		<tr>
		<td><input type="text" value="${item.kmId}" name="regname" style="border:0; background-color:transparent; text-align: center; width:100%;" readonly/></td>
		<td>${item.kmName}</td>
		<td>${item.kmHak}</td>
		<td>${item.kmBan}</td>
		<td>${item.kmDay}</td>
		...
		<td>${item.kmIsu}</td>
		<td>${item.kmGrade}</td>
		<td><button type="submit" onclick="div1.reload" class="btn btn-sm btn-primary btn-block">신청</button></td>
		</tr>
		</form>
		</c:forEach>
	</tbody>
	...
	<div class="padding1">
		...
		<form action="subreg" method="post">
		<tr>
		<td><input type="text" value="${item.kmId}" name="deleteclass" style="border:0; background-color:transparent; text-align: center; width:100%;" readonly/></td>
		<td>${item.kmName}</td>
		<td>${item.kmHak}</td>
		<td>${item.kmBan}</td>
		<td>${item.kmDay}</td>
		...
		<td>${item.kmIsu}</td>
		<td>${item.kmGrade}</td>
		<td><button type="submit" class="btn btn-sm btn-primary btn-block">취소</button></td>
		</tr>
		</form>
		</c:forEach>
	</tbody>
